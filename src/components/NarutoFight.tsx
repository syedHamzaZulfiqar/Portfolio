...
import styles from './NarutoFight.module.css';
...
export const NarutoFight: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const getPose = (time: number, isNaruto: boolean): NinjaPose => {
            ...
            // STAGE 1: (0.0s - 5.0s) Standoff & Ninja Run Dash
            if (t < 5.0) {
                if (t < 1.5) {
                    ...
                    torsoAngle = isNaruto ? 0.65 : -0.65;
                    leftUpperArm = isNaruto ? -1.3 : 1.3;
            ...
            // STAGE 2: (5.0s - 11.0s) Taijutsu & Kusanagi Sword Duel
            ...
            // STAGE 3: (11.0s - 17.0s) Shadow Clone Feint & Teleport
            ...
            // STAGE 4: (17.0s - 24.0s) Kyuubi Shroud vs Chidori Awakening
            ...
            // STAGE 5: (24.0s - 33.0s) RASENGAN VS CHIDORI RUN & CLASH
            ...
            // STAGE 6: (33.0s - 38.0s) Blowback & Reset
            else {
                const p = (t - 33.0) / 5.0;
                if (p < 0.6) {
                    const blastP = p / 0.6;
        ...
        const drawNinja = (pose: NinjaPose, isNaruto: boolean, alpha = 1.0) => {
            ...
            if (isNaruto) {
                ...
                drawPixelRect(headCenterX + facing * 1.5, headCenterY - 3.8, 4.5, 2.2, '#E0E0E0', '#888888');
        ...
        const drawRasenganChidoriClash = (nPose: NinjaPose, sPose: NinjaPose) => {
            ...
            clashGrad.addColorStop(0.3, '#00F0FF');
            clashGrad.addColorStop(0.65, '#6A4C93');
            clashGrad.addColorStop(0.9, 'rgba(10, 5, 20, 0.7)');
    ...
    return (
        <div 
            ref={containerRef}
            className={styles.narutoFightContainer}
